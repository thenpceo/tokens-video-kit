...
For the repeatable "top 4 assets by 24h volume" post, use `templates/trending-assets/render-trending-assets.mjs`. It refreshes Tokens API data/logos, generates a beat-forward ElevenLabs instrumental, keeps the current approved footer/card/count-up/SFX design choices, validates with HyperFrames, and renders a timestamped MP4.
